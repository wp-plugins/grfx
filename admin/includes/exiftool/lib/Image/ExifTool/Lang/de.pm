...
%Image::ExifTool::Lang::de::Translate = (
   ...
   'AFAndMeteringButtons' => {
      Description => 'AF And Megrfx-Tasten',
      PrintConv => {
        'AE lock' => 'AE Speicherung',
        'AF stop' => 'AE Stopp',
   ...
   'AlphaDataDiscard' => {
      ...
      PrintConv => {
        ...
        'HighPass Frequency Data Discarded' => 'Hochpagrfx-Frequenz-Daten verworfen',
        'Highpass and LowPass Frequency Data Discarded' => 'Hochpagrfx- und Tiefpagrfx-Frequenz-Daten verworfen',
      },
    },
   ...
   'AssistButtonFunction' => {
      ...
      PrintConv => {
        ...
        'Select HP (while pressing)' => 'Ausw.G.pos.(Agrfx-Taste gedr.)',
   ...
   'ShutterCurtainSync' => {
      Description => 'Verschlugrfx-Synchronisation',
      PrintConv => {
